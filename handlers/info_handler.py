...
import struct
from config.settings import GAME_PORT, GAME_APP_ID, SERVER_NAME, VERSION_GAME
...
async def handle_info_query(data, addr, players):
    ...
    keywords = b'BUILDID:0,OWNINGID:90263762545778710,OWNINGNAME:' + SERVER_NAME + B',SESSIONFLAGS:552,MATCHTIMEOUT_f:120.000000,GameMode_s:SG\x00'
    ...
    response = (
            ...
            VERSION_GAME + b'\x00' +  # Версия игры
