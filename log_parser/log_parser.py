...
import os
import asyncio
from log_parser.ddos_protection import DDOSProtection
from utils.constants import UNIFIED_LOGIN_PATTERN, LOGOUT_PATTERN_OLD, LOGOUT_PATTERN_NEW, IP_TIMESTAMP_PATTERN, \
    DDOS_THRESHOLD, DDOS_INTERVAL
from utils.async_watchdog import watch_directory
...
async def parse_log(log_file):
    ...
    # Полный парсинг
    logger.debug(f"Полный парсинг {log_file}")
    try:
    ...
    logger.debug(f"Полный парсинг {log_file} завершен.")
